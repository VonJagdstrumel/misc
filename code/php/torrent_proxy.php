...
/*
 * Launch using 'php -S 127.0.0.1:8080 torrentproxy.php'
 ...
 * Insert it in 'http://127.0.0.1:8080/<base64_encoded_tracker_url>/announce' (e.g. http://127.0.0.1:8080/aHR0cDovL2V4YW1wbGUtdHJhY2tlci5uZXQ6ODAwMC9zb21lLXVzZXIta2V5Lw/announce)
